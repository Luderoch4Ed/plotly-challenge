function getPlot(id) {
    d3.json("samples.json").then((data)=> {
        ...
        // Top 10 ids for plotting
        var samplevalues = samples.sample_values.slice(0, 10).reverse();

        // Only top 10 otu ids, reversing for better plotting
        ...
        // Setting parameters for bubble plot 
        var trace1 = {
            x: samples.otu_ids,
        ...
        var data_g = [
          ...
          title: { text: `Weekly Cleaning Frequency ` },
          type: "indicator",       
          mode: "gauge+number",
